...
"""
        ...
        commands = [
            ...
            f"{PYTHON_CMD} manage.py migrate horilla_audit --fake",
            f"{PYTHON_CMD} manage.py migrate base 0003 --fake",
            f"{PYTHON_CMD} manage.py migrate base 0004",
            f"{PYTHON_CMD} manage.py migrate horilla_theme",
            f"{PYTHON_CMD} manage.py migrate horilla_meet",
            f"{PYTHON_CMD} manage.py migrate horilla_ldap",
